// lib/features/training_generation/tg_result_screen.dart (새 파일)
  ...
  Future<void> _addToCalendar() async {
    ...
    try {
      ...
      final calendarEvent = {
        ...
        'totalTime': widget.totalElapsedTime,
        'trainings': widget.session.trainings.map((t) => t.toMap()).toList(),
        'createdAt': FieldValue.serverTimestamp(),
      };


      // Firebase에 저장
      await _firestore.collection('calendar_events').add(calendarEvent);
